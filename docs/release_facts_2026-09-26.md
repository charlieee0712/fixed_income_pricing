...
**Generated from the live repository at `2d111d3` (working tree DIRTY) on 2026-09-26.** Every number below is
...
| `phase2_risk_2009-03-31.csv` | 63 | `d051206c5d73323cf41c46ab51d55152` |
| `phase2_risk_2009-06-10.csv` | 63 | `c06e5a9ebf06f0bb5d9818c51e949f80` |
...
| `pool_risk_2009-03-31.csv` | 505 | `6433db5ebd66241729afb0bf8107ccde` |
| `pool_risk_2009-06-10.csv` | 478 | `86891918319bb0d6af70a1cc76b49661` |
...
| `pool_disposition_2009-03-31.csv` | 882 | `19b95961594cc7a0de5cd342a3ec6176` |
| `pool_disposition_2009-06-10.csv` | 882 | `566751ca6c6f4e42c26e77b2f4d89200` |
...
| `phase2_risk_2009-03-31.csv` | 19 | `2dc791d72146fb95` |
| `phase2_risk_2009-06-10.csv` | 19 | `d38043e53ab70c3c` |
| `sovereign_risk_2009-03-31.csv` | 20 | `92c2a10ec6287756` |
| `sovereign_risk_2009-06-10.csv` | 20 | `b9519b9260184405` |
| `pool_risk_2009-03-31.csv` | 12 | `d4d022e3b04735bb` |
| `pool_risk_2009-06-10.csv` | 10 | `f56d434a13554d91` |
...
| `pool_disposition_2009-03-31.csv` | 4 | `e64e4e90c7fd0844` |
| `pool_disposition_2009-06-10.csv` | 4 | `ca7d4e5eb730b174` |
...
`pytest -q` → **594 passed in 57.68s** (local, Python 3.13.5).
